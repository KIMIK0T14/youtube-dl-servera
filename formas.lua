...
function FormasModule.init(ENV)
	...
	-- ─────────────────────────────────────────────────────────────────
	-- FONT BITMAPS  (7×5 grid, each char = 35 bits, LSB = col0,row0)
	-- Row 0 = bottom, Row 6 = top.  1 = filled pixel.
	-- ─────────────────────────────────────────────────────────────────
	local FONT_DATA = {}

	-- helper: build a glyph from a string of 7 rows (each 5 chars, '1'/'0', top-to-bottom)
	local function G(...)
		local rows={...}; assert(#rows==7,"need 7 rows")
		local bits=0
		for r=1,7 do
			local row=rows[r]
			for c=1,5 do
				if row:sub(c,c)=="1" then
					-- store row 0 = top of visual (rows[1])
					local bit=(r-1)*5+(c-1)
					bits=bits+2^bit
				end
			end
	...
	-- FONT_DATA["NORMAL"]  – classic pixel/blocky
	FONT_DATA["NORMAL"] = {}
	local N = FONT_DATA["NORMAL"]
	-- uppercase
	N["A"]=G("01110","10001","10001","11111","10001","10001","10001")
	N["B"]=G("11110","10001","10001","11110","10001","10001","11110")
	N["C"]=G("01111","10000","10000","10000","10000","10000","01111")
	N["D"]=G("11110","10001","10001","10001","10001","10001","11110")
	N["E"]=G("11111","10000","10000","11110","10000","10000","11111")
	N["F"]=G("10000","10000","10000","11110","10000","10000","11111")
	N["G"]=G("01111","10001","10001","10111","10000","10000","01111")
	N["H"]=G("10001","10001","10001","11111","10001","10001","10001")
	N["I"]=G("01110","00100","00100","00100","00100","00100","01110")
	N["J"]=G("01110","10010","00010","00010","00010","00010","00111")
	N["K"]=G("10001","10010","10100","11000","10100","10010","10001")
	N["L"]=G("11111","10000","10000","10000","10000","10000","10000")
	N["M"]=G("10001","10001","10101","10101","11011","10001","10001")
	N["N"]=G("10001","10001","10011","10101","11001","10001","10001")
	N["O"]=G("01110","10001","10001","10001","10001","10001","01110")
	N["P"]=G("10000","10000","10000","11110","10001","10001","11110")
	N["Q"]=G("01101","10011","10001","10001","10001","10001","01110")
	N["R"]=G("10001","10010","10100","11110","10001","10001","11110")
	N["S"]=G("01111","10000","10000","01110","00001","00001","11110")
	N["T"]=G("00100","00100","00100","00100","00100","00100","11111")
	N["U"]=G("01110","10001","10001","10001","10001","10001","10001")
	N["V"]=G("00100","01010","01010","10001","10001","10001","10001")
	N["W"]=G("10001","11011","10101","10101","10001","10001","10001")
	N["X"]=G("10001","10001","01010","00100","01010","10001","10001")
	N["Y"]=G("00100","00100","00100","01010","01010","10001","10001")
	N["Z"]=G("11111","00001","00010","00100","01000","10000","11111")
	-- lowercase (same bitmaps, slightly different for descenders but fits 7 rows)
	N["a"]=G("01111","10001","01111","00001","01110","00000","00000")
	N["b"]=G("11110","10001","10001","11110","10000","10000","10000")
	N["c"]=G("01111","10000","10000","10000","01111","00000","00000")
	N["d"]=G("01111","10001","10001","01111","00001","00001","00001")
	N["e"]=G("01110","10000","11111","10001","01110","00000","00000")
	N["f"]=G("01100","00100","00100","01110","00100","00100","00011")
	N["g"]=G("01110","00001","01111","10001","01111","00000","00000")
	N["h"]=G("10001","10001","10001","11110","10000","10000","10000")
	N["i"]=G("01110","00100","00100","00100","00000","00100","00000")
	N["j"]=G("01100","10010","00010","00010","00010","00010","00000")
	N["k"]=G("10010","10100","11000","10100","10010","10000","10000")
	N["l"]=G("01110","00100","00100","00100","00100","00100","00100")
	N["m"]=G("10101","10101","10101","11011","00000","00000","00000")
	N["n"]=G("10001","10001","10001","11110","00000","00000","00000")
	N["o"]=G("01110","10001","10001","10001","01110","00000","00000")
	N["p"]=G("10000","10000","11110","10001","11110","00000","00000")
	N["q"]=G("00001","00001","01111","10001","01111","00000","00000")
	N["r"]=G("10000","10000","10000","11011","00000","00000","00000")
	N["s"]=G("11110","00001","01110","10000","01111","00000","00000")
	N["t"]=G("01100","00100","00100","00100","01110","00000","00000")
	N["u"]=G("01111","10001","10001","10001","00000","00000","00000")
	N["v"]=G("00100","01010","10001","10001","00000","00000","00000")
	N["w"]=G("10101","10101","10101","10001","00000","00000","00000")
	N["x"]=G("10001","01010","00100","01010","10001","00000","00000")
	N["y"]=G("01110","10000","01111","10001","01111","00000","00000")
	N["z"]=G("11111","00010","00100","01000","11111","00000","00000")
	-- digits
	N["0"]=G("01110","10101","10011","10001","10001","10001","01110")
	N["1"]=G("01110","00100","00100","00100","00100","01100","00100")
	N["2"]=G("11111","01000","00100","00010","00001","00001","01110")
	N["3"]=G("01110","00001","00001","00111","00001","00001","01110")
	N["4"]=G("00010","00010","11111","10010","01010","00110","00010")
	N["5"]=G("01111","00001","00001","01111","10000","10000","11111")
	N["6"]=G("01110","10001","10001","11110","10000","10000","01110")
	N["7"]=G("00100","00100","00100","00100","00010","00001","11111")
	N["8"]=G("01110","10001","10001","01110","10001","10001","01110")
	N["9"]=G("01110","00001","00001","01111","10001","10001","01110")
	-- punctuation / symbols
	N[" "]=G("00000","00000","00000","00000","00000","00000","00000")
	N["!"]=G("00100","00000","00100","00100","00100","00100","00100")
	N["?"]=G("00100","00000","00100","00010","00001","10001","01110")
	N["."]=G("00000","00000","00000","00000","00000","00000","00100")
	N[","]=G("01000","00100","00000","00000","00000","00000","00100")
	N[":"]=G("00000","00100","00000","00000","00000","00100","00000")
	N[";"]=G("01000","00100","00000","00000","00000","00100","00000")
	N["-"]=G("00000","00000","00000","11111","00000","00000","00000")
	N["_"]=G("11111","00000","00000","00000","00000","00000","00000")
	N["("]=G("01000","00100","00100","00100","00100","00100","01000")
	N[")"]=G("00010","00100","00100","00100","00100","00100","00010")
	N["/"]=G("10000","01000","01000","00100","00010","00010","00001")
	N["\\"]=G("00001","00010","00010","00100","01000","01000","10000")
	N["+"]=G("00100","00100","11111","00100","00100","00000","00000")
	N["*"]=G("00000","10101","01110","11111","01110","10101","00000")
	N["#"]=G("01010","11111","01010","01010","11111","01010","00000")
	N["@"]=G("01110","10000","10111","10101","10111","10001","01110")
	N["$"]=G("01111","10100","10100","01110","00101","00101","11110")
	N["%"]=G("00001","10010","00100","00100","01001","10001","00000") -- simplified
	N["&"]=G("01101","10010","01101","01010","00100","00100","00000")
	N["="]=G("00000","11111","00000","11111","00000","00000","00000")
	N["<"]=G("00010","00100","01000","10000","01000","00100","00010")
	N[">"]=G("01000","00100","00010","00001","00010","00100","01000")
	N["["]=G("01110","01000","01000","01000","01000","01000","01110")
	N["]"]=G("01110","00010","00010","00010","00010","00010","01110")
	N["{"]=G("00110","00100","00100","01000","00100","00100","00110")
	N["}"]=G("01100","00100","00100","00010","00100","00100","01100")
	N["|"]=G("00100","00100","00100","00100","00100","00100","00100")
	N["~"]=G("00000","00000","00000","10101","01010","00000","00000")
	N["^"]=G("00000","00000","00000","00000","10001","01010","00100")
	N["'"]=G("00000","00000","00000","00000","00000","01000","00100")
	N['"']=G("00000","00000","00000","00000","00000","01010","01010")
	N["`"]=G("00000","00000","00000","00000","00000","00010","00100")

	-- FONT_DATA["BOLD"] – thicker strokes (6px wide chars, padded)
	FONT_DATA["BOLD"] = {}
	local B2 = FONT_DATA["BOLD"]
	-- Bold is the same bitmap but we'll render at thicker block size (handled in gS)
	-- Copy all chars from NORMAL and tag as bold
	setmetatable(B2,{__index=N})
	B2["_isBold"]=true

	-- FONT_DATA["SLIM"] – condensed, narrower
	FONT_DATA["SLIM"] = {}
	local SL2 = FONT_DATA["SLIM"]
	-- Slim uses 3-wide chars instead of 5; rebuild subset
	local function GS(...)  -- 7 rows × 3 cols
		local rows={...}; assert(#rows==7)
		local bits=0
		for r=1,7 do
			local row=rows[r]
			for c=1,3 do
	...
	SL2["A"]=GS("010","101","111","101","101","101","010")
	SL2["B"]=GS("110","101","110","101","101","101","110")
	SL2["C"]=GS("011","100","100","100","100","100","011")
	SL2["D"]=GS("110","101","101","101","101","101","110")
	SL2["E"]=GS("111","100","100","110","100","100","111")
	SL2["F"]=GS("100","100","100","110","100","100","111")
	SL2["G"]=GS("011","101","100","111","100","100","011")
	SL2["H"]=GS("101","101","111","101","101","101","101")
	SL2["I"]=GS("111","010","010","010","010","010","111")
	SL2["J"]=GS("011","010","010","010","010","110","010")
	SL2["K"]=GS("101","101","110","100","110","101","101")
	SL2["L"]=GS("111","100","100","100","100","100","100")
	SL2["M"]=GS("101","111","111","101","101","101","101")
	SL2["N"]=GS("101","111","111","101","101","101","101")
	SL2["O"]=GS("010","101","101","101","101","101","010")
	SL2["P"]=GS("100","100","110","101","110","101","110")
	SL2["Q"]=GS("011","101","101","101","101","101","010")
	SL2["R"]=GS("101","101","110","101","110","101","110")
	SL2["S"]=GS("011","100","100","010","001","001","110")
	SL2["T"]=GS("010","010","010","010","010","010","111")
	SL2["U"]=GS("010","101","101","101","101","101","101")
	SL2["V"]=GS("010","010","101","101","101","101","101")
	SL2["W"]=GS("101","111","101","101","101","101","101")
	SL2["X"]=GS("101","101","010","010","010","101","101")
	SL2["Y"]=GS("010","010","010","101","101","101","101")
	SL2["Z"]=GS("111","001","010","010","010","100","111")
	SL2[" "]=GS("000","000","000","000","000","000","000")
	-- lowercase slim – share uppercase shapes for compactness
	setmetatable(SL2,{__index=function(t,k)
		if type(k)=="string" and k:match("^%l$") then return rawget(SL2,k:upper()) or rawget(N,k) end
		return rawget(N,k)
	end})
	SL2["_isSlim"]=true
	SL2["_cols"]=3

	-- FONT_DATA["CAPS"] – uppercase forced
	FONT_DATA["CAPS"] = {}
	setmetatable(FONT_DATA["CAPS"],{__index=function(_,k)
		if type(k)=="string" and k:match("^%a$") then
			return N[k:upper()] or N[k]
		end
		return N[k]
	end})
	FONT_DATA["CAPS"]["_isCaps"]=true

	-- ─────────────────────────────────────────────────────────────────
	-- TEXT → BLOCK PLAN
	-- ─────────────────────────────────────────────────────────────────
	local function buildTextPlan(plan,cx,cy,cz,params)
		local text      = params.text or "HOLA"
		local fontKey   = params.fontKey or "NORMAL"
		local cellW     = params.cellW or 1       -- block size per pixel (width)
		local cellH     = params.cellH or 1       -- block size per pixel (height)
		local letterSp  = params.letterSp or 1    -- extra spacing between letters (pixels)
		local wordSp    = params.wordSp or 2      -- extra spacing between words (pixels)
		local lineSp    = params.lineSp or 2      -- extra rows between lines
		local wordsPerLine = math.max(1, math.floor(params.wordsPerLine or 0)) -- 0 = free (all on one line)
		local thick     = params.thick or 1
		local scaleX    = params.scaleX or 1      -- horizontal stretch
		local scaleY    = params.scaleY or 1      -- vertical stretch (fat/thin letters)
		local detail    = math.max(1, math.floor(params.detail or 1)) -- pixel skip (1=full,2=half,etc)

		local font      = FONT_DATA[fontKey] or FONT_DATA["NORMAL"]
		local isSlim    = rawget(font,"_isSlim")
		local charCols  = isSlim and (rawget(font,"_cols") or 3) or 5
		local charRows  = 7

		-- Split text into words, then arrange into lines
		local words = {}
		for w in (text.." "):gmatch("([^ ]*) ") do
			if w~="" then words[#words+1]=w end
		end
		local lines = {}
		if wordsPerLine==0 then
			-- All words on one line
			lines[1] = table.concat(words," ")
		else
			local cur={}
			for i,w in ipairs(words) do
				cur[#cur+1]=w
				if #cur>=wordsPerLine or i==#words then
		...
		-- Per pixel block placement
		local function addBlock(bx,by,bz,bsx,bsy,bsz)
			plan[#plan+1]={
				cframe=CFrame.new(bx,by,bz),
				size=Vector3.new(bsx,bsy,bsz),
			}
		end

		local lineHeight = charRows*cellH*scaleY + lineSp*cellH
		local totalLines = #lines

		for lineIdx,lineStr in ipairs(lines) do
			local lineY = cy + (totalLines-lineIdx)*lineHeight

			-- compute total line width for centering
			local lineWidthPx = 0
			for ci=1,#lineStr do
				local ch=lineStr:sub(ci,ci)
				local isSpace=(ch==" ")
				lineWidthPx = lineWidthPx + (isSpace and (charCols+wordSp) or charCols)
				if ci<#lineStr then lineWidthPx=lineWidthPx+letterSp end
			end

			local startX = cx - (lineWidthPx*cellW*scaleX)/2

			local cursorX = startX
			for ci=1,#lineStr do
				local ch=lineStr:sub(ci,ci)
				if ch==" " then
					cursorX = cursorX + (charCols+wordSp)*cellW*scaleX
				else
					local bits = font[ch] or font["?"] or 0
					for row=0,charRows-1,detail do
						for col=0,charCols-1,detail do
							local bitIdx=row*5+col
							if math.floor(bits/2^bitIdx)%2==1 then
								local bx2 = cursorX + col*cellW*scaleX + (cellW*scaleX*detail/2)
								local by2 = lineY   + row*cellH*scaleY + (cellH*scaleY*detail/2)
								local bsz2= cellW*scaleX*detail*1.02
								local bsy2= cellH*scaleY*detail*1.02
								addBlock(bx2,by2,cz,bsz2,bsy2,thick)
							end
						end
					end
					cursorX = cursorX + (charCols+letterSp)*cellW*scaleX
				end
			end
		end
	end
	...
	-- ─────────────────────────────────────────────────────────────────
	-- EXISTING GEOMETRY BUILDERS (unchanged)
	-- ─────────────────────────────────────────────────────────────────
	local gS,SHAPES
	do
		...
		SHAPES={
			...
			-- ↓ Nueva geometría de texto
			{label="Texto",    icon="text",    kind="text",     caps=false, fillable=false,useHeight=false,useCount=false,usePoint=false,isText=true},
		}
		gS=function(def,cp,P)
			...
			elseif k=="text" then buildTextPlan(plan,cx,cy,cz,P)
			end
	...
	do
		...
		drawIcon=function(container,def,col)
			...
			elseif ic=="heart" then local scale=R*0.82; local pts={}; local N2=32; for k2=0,N2-1 do local t=(k2/N2)*2*math.pi; local px=16*math.sin(t)^3; local py=-(13*math.cos(t)-5*math.cos(2*t)-2*math.cos(3*t)-math.cos(4*t)); pts[k2+1]={cx2+px*scale/17,cy2+py*scale/17} end; for i=1,N2 do local a2=pts[i]; local b2=pts[(i%N2)+1]; dLine(container,a2[1],a2[2],b2[1],b2[2],col) end
			elseif ic=="text" then
				-- Draw a pixel "T" with pixel dots to represent text/blocks icon
				local s=R*0.7
				-- T crossbar
				dLine(container,cx2-s,cy2-s*0.8,cx2+s,cy2-s*0.8,col)
				-- T stem
				dLine(container,cx2,cy2-s*0.8,cx2,cy2+s*0.8,col)
				-- little pixel dots below to suggest blocks
				local dotR=math.max(2,bsz/12)
				for di=-1,1 do
					local dx=cx2+di*(dotR*2.5); local dy=cy2+s*0.4
					mk("Frame",container,{AnchorPoint=Vector2.new(0.5,0.5),Position=UDim2.fromOffset(dx,dy),Size=UDim2.fromOffset(dotR,dotR),BackgroundColor3=col,BorderSizePixel=0})
				end
			end
		end
	end
	...
	local rP=function()
		...
		if def and def.isText then
			baseP.text        = BInput.tTextBox   and BInput.tTextBox.Text   or "HOLA"
			baseP.fontKey     = BInput.tFontKey   or "NORMAL"
			baseP.cellW       = math.max(0.1, tonumber(BInput.tCellW    and BInput.tCellW.Text)    or 1)
			baseP.cellH       = math.max(0.1, tonumber(BInput.tCellH    and BInput.tCellH.Text)    or 1)
			baseP.letterSp    = math.max(0,   tonumber(BInput.tLetterSp and BInput.tLetterSp.Text) or 1)
			baseP.wordSp      = math.max(0,   tonumber(BInput.tWordSp   and BInput.tWordSp.Text)   or 2)
			baseP.lineSp      = math.max(0,   tonumber(BInput.tLineSp   and BInput.tLineSp.Text)   or 2)
			baseP.wordsPerLine= math.max(0,   math.floor(tonumber(BInput.tWPL and BInput.tWPL.Text) or 0))
			baseP.thick       = math.max(0.1, tonumber(BInput.tThick    and BInput.tThick.Text)    or 1)
			baseP.scaleX      = math.max(0.1, tonumber(BInput.tScaleX   and BInput.tScaleX.Text)   or 1)
			baseP.scaleY      = math.max(0.1, tonumber(BInput.tScaleY   and BInput.tScaleY.Text)   or 1)
			baseP.detail      = math.max(1,   math.floor(tonumber(BInput.tDetail  and BInput.tDetail.Text)  or 1))
		end
		return baseP
	end
	...
	-- ─────────────────────────────────────────────────────────────────
	-- CLASSIC GEOMETRY ROWS
	-- ─────────────────────────────────────────────────────────────────
	do
		local function notText() local d=SHAPES[sS]; return not(d and d.isText) end
		local rRad=bRow(24,notText); BInput.bRadius=mkNumRow(rRad,"Radio","20",1,0.01)
		local rCnt=bRow(24,function() local d=SHAPES[sS]; return d and d.useCount~=false and not(d.isText) end); BInput.bSteps=mkNumRow(rCnt,"Parts","120",4,4)
		local rHgt=bRow(24,function() local d=SHAPES[sS]; return d and d.useHeight==true and not(d.isText) end); BInput.bSizeY=mkNumRow(rHgt,"Altura","8",1,0.01)
		local rThk=bRow(24,notText); BInput.bThick=mkNumRow(rThk,"Grosor","1",0.1,0.01)
	...
	-- TEXT-ONLY ROWS
	-- ─────────────────────────────────────────────────────────────────
	local TEXT_FONTS = {"NORMAL","BOLD","SLIM","CAPS"}

	do
		local function isText() local d=SHAPES[sS]; return d and d.isText==true end

		-- Row: text input (tall, 2 lines)
		local rTxt=bRow(52,isText)
		lbl(rTxt,"Texto",UDim2.new(0,50,0,18),UDim2.new(0,0,0,0),T.sub)
		-- Indicator label showing "MAYÚS / minús"
		local caseLbl=mk("TextLabel",rTxt,{Size=UDim2.new(1,-54,0,14),Position=UDim2.new(0,54,0,0),BackgroundTransparency=1,Font=Enum.Font.Gotham,TextSize=9,TextColor3=T.sub,TextXAlignment=Enum.TextXAlignment.Right,Text=""})
		local tBox=mk("TextBox",rTxt,{Size=UDim2.new(1,-4,0,32),Position=UDim2.new(0,2,0,18),BackgroundColor3=T.input,BorderSizePixel=0,Font=Enum.Font.GothamSemibold,TextSize=12,TextColor3=T.text,PlaceholderText="Escribe aquí...",Text="HOLA MUNDO",ClearTextOnFocus=false,MultiLine=false,TextXAlignment=Enum.TextXAlignment.Left})
		corner(tBox,6); pad(tBox,0,0,0,6)
		BInput.tTextBox=tBox
		-- Update case indicator on text change
		tBox:GetPropertyChangedSignal("Text"):Connect(function()
			local t=tBox.Text
			local hasLower=t:match("%l") and true or false
			local hasUpper=t:match("%u") and true or false
			if hasLower and hasUpper then caseLbl.Text="Aa mixto"
			elseif hasLower then caseLbl.Text="minúsculas"
			elseif hasUpper then caseLbl.Text="MAYÚSCULAS"
			else caseLbl.Text="" end
			mPv()
		end)
		-- Trigger initial case display
		task.defer(function()
			local t=tBox.Text
			local hasLower=t:match("%l") and true or false
			local hasUpper=t:match("%u") and true or false
		...
		-- Row: font selector (scrollable horizontal button strip)
		local rFont=bRow(32,isText)
		lbl(rFont,"Fuente",UDim2.new(0,50,1,0),UDim2.new(0,0,0,0),T.sub)
		local fontScroll=mk("ScrollingFrame",rFont,{Size=UDim2.new(1,-54,1,0),Position=UDim2.new(0,54,0,0),BackgroundTransparency=1,BorderSizePixel=0,ScrollBarThickness=3,ScrollBarImageColor3=T.accent,ScrollingDirection=Enum.ScrollingDirection.X,AutomaticCanvasSize=Enum.AutomaticSize.X,CanvasSize=UDim2.new(0,0,1,0)})
		mk("UIListLayout",fontScroll,{FillDirection=Enum.FillDirection.Horizontal,Padding=UDim.new(0,4),SortOrder=Enum.SortOrder.LayoutOrder,VerticalAlignment=Enum.VerticalAlignment.Center})
		local fontBtns={}
		local function setFont(fk)
			BInput.tFontKey=fk
			for _,fb in ipairs(fontBtns) do
				fb.btn.BackgroundColor3=(fb.key==fk) and T.btn or T.btnAlt
			end
			mPv()
		end
		local FONT_LABELS={NORMAL="Normal",BOLD="Bold",SLIM="Slim",CAPS="CAPS"}
		for i,fk in ipairs(TEXT_FONTS) do
			local fb=btn(fontScroll,FONT_LABELS[fk] or fk,UDim2.new(0,52,0,22),nil,T.btnAlt)
			fb.LayoutOrder=i; corner(fb,6)
			fontBtns[#fontBtns+1]={btn=fb,key=fk}
			fb.MouseButton1Click:Connect(function() setFont(fk) end)
		end
		setFont("NORMAL")
		BInput.tFontKey="NORMAL"

		-- Row: cell width (tamaño bloque horizontal)
		local rCW=bRow(24,isText); BInput.tCellW=mkNumRow(rCW,"Tam.Bloque","1",0.5,0.1)

		-- Row: scaleX (stretch horizontal) and scaleY (fat/thin letters)
		local rSXY=bRow(24,isText)
		lbl(rSXY,"Ancho",UDim2.new(0,40,1,0),UDim2.new(0,0,0,0),T.sub)
		local sxBox=box(rSXY,UDim2.new(0,44,0,22),UDim2.new(0,42,0,0),"1"); sxBox.TextXAlignment=Enum.TextXAlignment.Center
		local sxG=false
		sxBox:GetPropertyChangedSignal("Text"):Connect(function() if sxG then return end; local c=cleanNum(sxBox.Text); if c~=sxBox.Text then sxG=true; sxBox.Text=c; sxG=false end; mPv() end)
		BInput.tScaleX=sxBox
		lbl(rSXY,"Alto",UDim2.new(0,30,1,0),UDim2.new(0,90,0,0),T.sub)
		local syBox=box(rSXY,UDim2.new(0,44,0,22),UDim2.new(0,120,0,0),"1"); syBox.TextXAlignment=Enum.TextXAlignment.Center
		local syG=false
		syBox:GetPropertyChangedSignal("Text"):Connect(function() if syG then return end; local c=cleanNum(syBox.Text); if c~=syBox.Text then syG=true; syBox.Text=c; syG=false end; mPv() end)
		BInput.tScaleY=syBox

		-- Row: letter spacing, word spacing
		local rSP=bRow(24,isText)
		lbl(rSP,"E.Letra",UDim2.new(0,44,1,0),UDim2.new(0,0,0,0),T.sub)
		local lspBox=box(rSP,UDim2.new(0,36,0,22),UDim2.new(0,46,0,0),"1"); lspBox.TextXAlignment=Enum.TextXAlignment.Center
		local lg=false
		lspBox:GetPropertyChangedSignal("Text"):Connect(function() if lg then return end; local c=cleanNum(lspBox.Text); if c~=lspBox.Text then lg=true; lspBox.Text=c; lg=false end; mPv() end)
		BInput.tLetterSp=lspBox
		lbl(rSP,"E.Palabra",UDim2.new(0,52,1,0),UDim2.new(0,86,0,0),T.sub)
		local wspBox=box(rSP,UDim2.new(0,36,0,22),UDim2.new(0,140,0,0),"2"); wspBox.TextXAlignment=Enum.TextXAlignment.Center
		local wg=false
		wspBox:GetPropertyChangedSignal("Text"):Connect(function() if wg then return end; local c=cleanNum(wspBox.Text); if c~=wspBox.Text then wg=true; wspBox.Text=c; wg=false end; mPv() end)
		BInput.tWordSp=wspBox

		-- Row: words per line + line spacing
		local rWPL=bRow(24,isText)
		lbl(rWPL,"Pal/Línea",UDim2.new(0,56,1,0),UDim2.new(0,0,0,0),T.sub)
		local wplBox=box(rWPL,UDim2.new(0,34,0,22),UDim2.new(0,58,0,0),"0"); wplBox.TextXAlignment=Enum.TextXAlignment.Center
		local wplHint=mk("TextLabel",rWPL,{Size=UDim2.new(0,30,1,0),Position=UDim2.new(0,94,0,0),BackgroundTransparency=1,Font=Enum.Font.Gotham,TextSize=9,TextColor3=T.sub,Text="(0=libre)"})
		local wplG=false
		wplBox:GetPropertyChangedSignal("Text"):Connect(function() if wplG then return end; local c=cleanNum(wplBox.Text); if c~=wplBox.Text then wplG=true; wplBox.Text=c; wplG=false end; mPv() end)
		BInput.tWPL=wplBox
		lbl(rWPL,"E.Línea",UDim2.new(0,44,1,0),UDim2.new(0,126,0,0),T.sub)
		local linspBox=box(rWPL,UDim2.new(0,34,0,22),UDim2.new(0,172,0,0),"2"); linspBox.TextXAlignment=Enum.TextXAlignment.Center
		local linspG=false
		linspBox:GetPropertyChangedSignal("Text"):Connect(function() if linspG then return end; local c=cleanNum(linspBox.Text); if c~=linspBox.Text then linspG=true; linspBox.Text=c; linspG=false end; mPv() end)
		BInput.tLineSp=linspBox

		-- Row: detail level (pixel skip) + thickness
		local rDT=bRow(24,isText)
		lbl(rDT,"Detalle",UDim2.new(0,44,1,0),UDim2.new(0,0,0,0),T.sub)
		local dtBox=box(rDT,UDim2.new(0,34,0,22),UDim2.new(0,46,0,0),"1"); dtBox.TextXAlignment=Enum.TextXAlignment.Center
		local dtHint=mk("TextLabel",rDT,{Size=UDim2.new(0,30,1,0),Position=UDim2.new(0,82,0,0),BackgroundTransparency=1,Font=Enum.Font.Gotham,TextSize=9,TextColor3=T.sub,Text="(1=máx)"})
		local dtG=false
		dtBox:GetPropertyChangedSignal("Text"):Connect(function() if dtG then return end; local c=cleanNum(dtBox.Text); if c~=dtBox.Text then dtG=true; dtBox.Text=c; dtG=false end; mPv() end)
		BInput.tDetail=dtBox
		lbl(rDT,"Grosor",UDim2.new(0,38,1,0),UDim2.new(0,116,0,0),T.sub)
		local tThkBox=box(rDT,UDim2.new(0,34,0,22),UDim2.new(0,156,0,0),"1"); tThkBox.TextXAlignment=Enum.TextXAlignment.Center
		local tThkG=false
		tThkBox:GetPropertyChangedSignal("Text"):Connect(function() if tThkG then return end; local c=cleanNum(tThkBox.Text); if c~=tThkBox.Text then tThkG=true; tThkBox.Text=c; tThkG=false end; mPv() end)
		BInput.tThick=tThkBox

		-- Unused refs to silence warnings
		local _=wplHint; local _=dtHint
	end
	...
	local function waitAndRecenter()
		task.spawn(function()
			for _=1,20 do
				task.wait(0.3)
				local ok2,ref=pcall(myRefPos)
				if ok2 and ref and ref.Y>-100 then
	...
	-- ─────────────────────────────────────────────────────────────────
	-- onShapeChange (extended for text)
	-- ─────────────────────────────────────────────────────────────────
	onShapeChange=function()
		local def=SHAPES[sS]; if not def then return end
		if def.isText then
			cTO=false; cBO=false
		elseif def.kind=="cube3d" then cTO=true; cBO=true
